    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half3 diffAlbedo = lerp(albedo.rgb, tex2D(_ShadowColor1stTex, i.uv).xyz * _ShadowColor1st.rgb, diffGradient.x);
                diffAlbedo = lerp(diffAlbedo.rgb, tex2D(_ShadowColor2ndTex, i.uv).xyz * _ShadowColor2nd.rgb, diffGradient.y);
